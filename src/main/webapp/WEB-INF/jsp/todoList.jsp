...
<div class="container">
    <div style="height: 40px; padding-left: 100px;padding-bottom: 30px">
        <ul style="font-size: 30px;">
            <li><a style="color: green;" href="/todo">Home</a></li>
...
<table>
    ...
    <c:forEach items="${list}" var="item">
        <tr>
            ...
            <td><form method="post" action="/todo/addtodone">
                <input type="hidden" name="id" value=${item.id} />
                <a class="aHover" onclick="this.parentNode.submit();">Done</a>
            </form></td>
   ...
   <div class="customDiv"> <a href="/todo/add"><svg style="color:#0e3401 " width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-plus " fill="currentColor" xmlns="http://www.w3.org/2000/svg">
